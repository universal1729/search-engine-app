...
# --- Search engine data ---
search_engines = {
    "Google": {"url": "https://www.google.com", "logo": GOOGLE_LOGO},
    "Yahoo": {"url": "https://www.yahoo.com", "logo": YAHOO_LOGO},
    "Bing": {"url": "https://www.bing.com", "logo": BING_LOGO},
    "DuckDuckGo": {"url": "https://www.duckduckgo.com", "logo": DUCK_LOGO},
}
...
<div class="card">
    ...
    <button onclick="toggle()">Select a search engine ▼</button>
...
function go(){
    if(!url) alert("Please select a search engine!");
